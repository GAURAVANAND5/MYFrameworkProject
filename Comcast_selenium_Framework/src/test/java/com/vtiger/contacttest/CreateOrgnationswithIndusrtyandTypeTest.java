...
public class CreateOrgnationswithIndusrtyandTypeTest {
	...
	public static void main(String[] args) throws Throwable {
		...
		String PASSWORD = fLib.getFileProperty("password");
		        ...
		        String industryName = eLib.getDataFromExcel("Contact", 4, 4);
		        String typeName = eLib.getDataFromExcel("Contact", 4,5);
				...
				wLib.select(typeList, typeName);
				
				
				driver.findElement(By.xpath("//input[@title='Save [Alt+S]']")).click();
				wLib.waitForElementVisibility(driver, typeList);
				
				 wLib.mouseOver(driver,driver.findElement(By.xpath("//img[contains(@src,'user')]")));
