...
public class SaveButtonIsEnableOrNot {
	...
	public void fillcreatepage()
	{
		...
		boolean logo = driver.findElement(By.xpath("(//input[@title='Save [Alt+S]'])[1]")).isEnabled();	
		if(logo==true)
		{
			Reporter.log("save button is enable",true);
			driver.findElement(By.xpath("(//input[@title='Save [Alt+S]'])[1]")).click();
		}
		else
		{
	
			Reporter.log("save button is disabled",true);
		}	
		
		String expectedname="singh raj- Contact Information";
		...
		{
			Reporter.log("Contacts not created",true);
		}
