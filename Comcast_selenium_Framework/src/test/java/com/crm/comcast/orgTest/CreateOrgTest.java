...
public class CreateOrgTest {
	...
	public static void main(String[] args) throws IOException {
		...
		String orgName=wb.getSheet("CreateOrg").getRow(2).getCell(2).getStringCellValue();
		String websitename = wb.getSheet("CreateOrg").getRow(2).getCell(3).getStringCellValue();
	    String phno = wb.getSheet("CreateOrg").getRow(2).getCell(4).getStringCellValue();
		String email= wb.getSheet("CreateOrg").getRow(2).getCell(5).getStringCellValue();
